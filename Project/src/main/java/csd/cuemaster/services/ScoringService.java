...
public class ScoringService {
     ...
     */
    public double calculateExpectedScore(int playerPoints, int opponentPoints) {
     ...
     */
    public int getDynamicKFactor(int score, int experienceLevel, double matchImportance) {
    ...
    public double getMatchImportanceMultiplier(Status matchStatus) {
        switch (matchStatus) {
            case ROUND_OF_32:
    ...
    public int calculateNewRating(int playerRating, double expectedScore, int result, Status matchStatus, int experienceLevel) {
