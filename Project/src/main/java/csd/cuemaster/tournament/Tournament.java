...
public class Tournament {
    ...
    private List<Profile> players = new ArrayList<>(); // Storing player participating in the tournament
    ...
    LocalTime time, Status status, String description, Long winnerId, List<Profile> players) {
