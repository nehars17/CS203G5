...
public class Match {
    ...
    public Match(Tournament tournament, User user1, User user2, LocalDate matchDate, LocalTime matchTime, int user1Score, int user2Score, String tournamentStatus) {
